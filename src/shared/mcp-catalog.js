export const MCP_RESOURCE_CATALOG = [
  ...
  { id: 'delivery-activity', label: 'Delivery activity', category: 'Platform', description: 'GitOps and delivery applications, projects, sources, and controller health', path: '/v1/delivery-activity', appPath: '/app/delivery-activity', namespaceScoped: true },
